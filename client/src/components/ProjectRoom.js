...
export default function ProjectRoom() {
    ...
    const FruitFlyDispenserProps = {
        ...
        setBlog: () => setActiveBlog('FruitFlyDispenser')
    };
    ...
    const TwoDPlotterProps = {
        ...
        setBlog: () => setActiveBlog('TwoDPlotter')
    };
    ...
    const ImmMachineProps = {
        ...
        setBlog: () => setActiveBlog('IMMMachineAssembly')
    };
    ...
    const DrawingSlicerProps = {
        ...
        setBlog: () => setActiveBlog('DrawingSlicer')
    };
    ...
    const SurfboardProps = {
        ...
        setBlog: () => setActiveBlog('SurfShaper')
    };
    ...
    return (
        <div className="technologies__technologies-canvas">
            ...
            <AboutTheProject project={activeBlog} />
        </div>
    )
}
